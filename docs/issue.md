...
| 12 | 🟠 | **R2 media bucket created + custom domain connected** (`r2.arthurarchive.com`, a placeholder domain — real one pending purchase), **but bucket is still empty.** | infra | studying | Bucket + custom domain done. Still pending: uploading real Opus/image files into the bucket, and a **recovery rehearsal**. Audio/downloads 404 until files are actually uploaded. See `docs/media-and-backup.md`. | P8 |
